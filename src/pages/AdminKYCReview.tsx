...
const AdminKYCReview = () => {
  ...
  const hasDocument = selectedRequest?.kyc_document_url && selectedRequest.kyc_document_url.length > 0;

  const handleApprove = () => {
    if (!selectedRequest || !hasDocument) return;
              ...
              <>
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    disabled={!hasDocument || approveKycMutation.isPending}
                  >
                    ...
                    {hasDocument ? "Approve" : "No Document"}
                  </Button>
                </div>

                {!hasDocument && (
                  <p className="text-xs text-red-400 text-center">
                    Approval disabled until document is uploaded
                  </p>
                )}
              </>
            ) : (
