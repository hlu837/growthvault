-- Drop all existing approve/reject functions to clear conflicts
...
-- Create approve_seller_application function with single parameter
...
-- Create reject_seller_application function
