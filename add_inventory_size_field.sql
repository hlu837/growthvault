-- Add inventory_size field to seller_applications table
ALTER TABLE public.seller_applications 
ADD COLUMN inventory_size INTEGER;

-- Update the apply_as_seller function to include inventory_size
CREATE OR REPLACE FUNCTION public.apply_as_seller(
    ...
    p_inventory_size INTEGER DEFAULT NULL,
...
BEGIN
    ...
    INSERT INTO seller_applications (
        ...
        p_monthly_revenue, p_inventory_size, p_kyc_documents, p_business_documents
